            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="flex justify-between">
                      ...
                      <span className="font-medium">{currentDriver.driverID}</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                  <h3 className="font-semibold text-green-800 mb-2">Salary Information</h3>
                  <div className="space-y-2">
                    <p className="flex justify-between">
                      <span className="text-gray-600">Monthly Salary:</span>
                      <span className="font-medium">₹{currentDriver.salary.toLocaleString()}</span>
                    </p>
                    <p className="flex justify-between">
                      <span className="text-gray-600">Payment Date:</span>
                      <span className="font-medium">{currentDriver.paymentDate}</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="flex justify-between">
                      ...
                      <span className="font-medium">{currentDriver.accountNo}</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <h3 className="font-semibold text-gray-800 mb-3">Salary History</h3>
        ...
        {activeDriverSection === "documents" && (
            ...
            <div className="mb-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-3 text-blue-800 border-b pb-2">Personal Information</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    <div className="bg-blue-50 p-3 border-b">
                      <h3 className="font-semibold text-blue-800">Aadhaar Card</h3>
                    </div>
                    <div className="p-4">
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    <div className="bg-green-50 p-3 border-b">
                      <h3 className="font-semibold text-green-800">Driving License</h3>
                    </div>
                    <div className="p-4">
                      <div className="aspect-[16/9] bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        <img 
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    <div className="bg-purple-50 p-3 border-b">
                      <h3 className="font-semibold text-purple-800">Address Proof</h3>
                    </div>
                    <div className="p-4">
                      <div className="aspect-[16/9] bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        <img 
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    <div className="bg-red-50 p-3 border-b">
                      <h3 className="font-semibold text-red-800">Police Verification</h3>
                    </div>
                    <div className="p-4">
                      <div className="aspect-[16/9] bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        <img 
                  ...
                  <div className="border rounded-lg overflow-hidden shadow-sm">
                    <div className="bg-indigo-50 p-3 border-b">
                      <h3 className="font-semibold text-indigo-800">Bank Details</h3>
                    </div>
                    <div className="p-4">
                      <div className="aspect-[16/9] bg-gray-100 rounded-lg mb-3 overflow-hidden">
                        <img 
